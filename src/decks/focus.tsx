          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: "50%",
                  background: connected ? ACCENT : "#555",
            ...
            {mood?.enabled && (
              ...
              >
                ...
                />
                <span style={{ textTransform: "lowercase", letterSpacing: "0.08em" }}>
                  {mood.emotion}
                </span>
              </div>
            )}
        ...
        <span
          style={{
            ...
            background:
              orbState === "idle"
                ? "transparent"
                : `radial-gradient(circle, ${ACCENT}44, transparent 70%)`,
