  ...
  return (
    <div
      style={{
        ...
        flexShrink: 0,
        opacity: 0.6 + 0.4 * Math.max(0, Math.min(1, energy)),
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          borderColor: active ? (speaking ? A.aCC : A.a70) : A.a55,
      ...
      >
        ...
        {/* Waveform bars */}
        <div
          style={{ display: "flex", gap: 2, alignItems: "flex-end", height: 16, marginBottom: 4 }}
        >
          {[0, 1, 2, 3, 4].map((i) => (
            <motion.div
              key={i}
